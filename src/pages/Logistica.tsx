  ...
  useEffect(() => {
    const channel = supabase
      ...
      .on('postgres_changes',
        ...
        async () => {
          // Recargar la vista cuando cambie cualquier pedido
          ...
          <div className="bg-surface border border-line rounded-xl p-5 space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-mute mt-2">
                Instantánea: cada pedido le llega al jefe al confirmarse. Agrupada: los pedidos se acumulan y le llegan todos al abrir.
              </p>
            </div>
          </div>
        </section>
